...
class Application(tk.Frame):
    ...
    def main_frame(self):
        ...
        self.play= ttk.Button(self.main, text='Play Game', width=10, command=self.play_game)
        self.play.grid(row=2,column=0, pady=20)

        self.quit = ttk.Button(self.main, text='Play Game', width=10, command=self.master.destroy)
        self.quit.grid(row=2, column=0, pady=20)
    ...
    def draw_body_frame(self):
        ...
        self.paper_user =tk.Label(self.body, image=rock_small,cursor='hand2')
        self.paper_user.grid(row=1, column=0, pady=(5,0), padx=(45,10))

        self.scissor_user =tk.Label(self.body, image=rock_small,cursor='hand2')
        ...
        self.paper_system = tk.Label(self.body, image=rock_small, cursor='hand2')
        self.paper_system.grid(row=1, column=5, pady=(5, 0), padx=(10, 10))

        self.scissor_system = tk.Label(self.body, image=rock_small, cursor='hand2')
    ...
    def draw_header_frame(self):
        self.title = tk.Label(self.header, text='가위 바위 보', fg='black',font='Verdana 14')
        ...
        #사용자명
        self.username = tk.Label(self.left, text=f'system', fg='dodgerblue3',
                                 font='verdana 10', padx=30)
        self.username.grid(row=0,column=0 , sticky='news')

        #포인트
        self.spoint = tk.Label(self.left,text=f'{self.sysPoint}',fg='dodgerblue3',
                               font= 'verdana 10')
    ...
    def draw_footer_frame(self):
        ...
        self.reset_btn.grid(row=0, column=0, padx=(20,20))

        self.home_btn = ttk.Button(self.footer, text='Home',command=self.go_home)
        self.reset_btn.grid(row=0, column=0, padx=(120,10), sticky='w')
